...
const RotatingText = forwardRef((props, ref) => {
  ...
  return (
    <motion.span
      ...
      {...rest}
      layout
      layoutId={`rotating-text-${currentTextIndex}`}
    ...
    >
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        <motion.div
          ...
          layout
          layoutId={`rotating-text-content-${currentTextIndex}`}
          ...
          {elements.map((wordObj, wordIndex, array) => {
            ...
            return (
              ...
              >
                ...
                {wordObj.needsSpace && (
                  <span className={cn("text-rotate-space", elementLevelClassName)} style={{ transition: "colors duration-150" }}> </span>
                )}
              </span>
            );
          })}
